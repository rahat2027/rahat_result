...
<div class="w3-row-padding rows">
	<p>
		<div class="w3-col m6"><label class="w3-text-blue"><b>From</b></label><input class="w3-input w3-border " name="froms" id="cal" value="<?php echo $fetchz->froms; ?>" type="text"></div>
<div class="w3-col m6"><label class="w3-text-blue"><b>To</b></label><input class="w3-input w3-border" name="tos"  id="cal2"  value="<?php echo $fetchz->tos; ?>"  type="text"></div>
	</p>
