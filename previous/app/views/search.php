...
<form action="" method="get">
	<div class="w3-row" style="width:80%;margin:auto;margin-left:40px;">
		...
		<div class="w3-col m3 s3"><input type="submit" value="Search" class="w3-btn w3-red" style="padding: 9px 16px!important;"></div>
	</div>
</form>
...
<br>
<center class="w3-center "><font  size="+2" class="w3-text-blue-grey">Grade Pattren</font><br>
<font color="#990066">'A' Grade - 75% &amp; Above<br>
'B' Grade - 60% &amp; Above<br>
'C' Grade - 50% &amp; Above<br>
'D' Grade - 40% &amp; Above<br></font></center>
</div>
